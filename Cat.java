...
public class Cat 
{
   ...
   {
      return "Cat{"+"name="+ name+'\''+", breed="+breed+'\''+", owner="+owner+'\''+", age="+age+'}';
   }
   ...
   public boolean equals(Object o)
   {
      ...
      Cat cat= (Cat) o;
      return age==cat.age && Objects.equals(name, cat.name) && Objects.equals(breed, cat.breed) && Objects.equals(owner, cat.owner) && Objects.equals(age, cat.age);
   }

   @Override
   public int hashCode()
   {
      return Objects.hash(name,breed,owner,age);
   }
